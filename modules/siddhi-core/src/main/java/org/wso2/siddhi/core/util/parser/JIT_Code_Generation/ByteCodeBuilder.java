...
public class ByteCodeBuilder {
    ...
    protected static void end(ClassWriter classWriter, MethodVisitor methodVisitor, ByteCodeGenerator byteCodeGenerator,
        ...
        if ((expressionExecutor instanceof ConditionExpressionExecutor || expressionExecutor instanceof ConstantExpressionExecutor)) {
            ...
            } else if (expressionExecutor.getReturnType() == Attribute.Type.FLOAT) {
                methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Float", "valueOf",
                        "(F)Ljava/lang/Float;", false);

            } else if (expressionExecutor.getReturnType() == Attribute.Type.INT) {
            ...
            } else if (expressionExecutor.getReturnType() == Attribute.Type.DOUBLE) {
